...
public interface IChartService
{
    ...
    Task<ChartResponse> UpdateChartAsync(Guid userId, Guid orgId, Guid eventId, Guid chartId, UpdateChartDto dto);
    Task DeleteChartAsync(Guid eventId, Guid orgId, Guid chartId);
}
