        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DetailAddress = table.Column<string>(type: "text", nullable: true),
                    ProvinceCode = table.Column<string>(type: "text", nullable: true),
                    CommuneCode = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Legends_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_Charts_ChartId",
                        column: x => x.ChartId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Legends_EventId",
                table: "Legends",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_Sessions_ChartId",
                table: "Sessions",
                column: "ChartId");
