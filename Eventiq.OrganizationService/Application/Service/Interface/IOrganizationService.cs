...
{
    Task<OrganizationDetail?> GetByIdAsync(Guid id, Guid? requesterId = null, CancellationToken cancellationToken = default);
    ...
    Task<List<UserOrganizationItem>> GetOrgsByUserAsync(Guid userId, CancellationToken cancellationToken = default);
}
