        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentConfiguredAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDesigner = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invitations_PermissionId",
                schema: "org_service",
                table: "Invitations",
                column: "PermissionId");

            migrationBuilder.CreateIndex(
                name: "IX_Invitations_Status_OrganizationId_UserId_UserEmail",
                schema: "org_service",
                table: "Invitations",
                columns: new[] { "Status", "OrganizationId", "UserId", "UserEmail" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Members_PermissionId",
                schema: "org_service",
                table: "Members",
                column: "PermissionId");

            migrationBuilder.CreateIndex(
                name: "IX_Organizations_OwnerEmail_Name",
                schema: "org_service",
                table: "Organizations",
                columns: new[] { "OwnerEmail", "Name" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_Name_OrganizationId",
                schema: "org_service",
                table: "Permissions",
