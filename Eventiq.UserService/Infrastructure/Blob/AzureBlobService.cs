...
namespace Eventiq.UserService.Infrastructure.Blob;
...
public class AzureBlobService : IBlobService
{
    ...
    public async Task<string> UploadAsync(Stream stream, string fileName, string contentType, string containerName = "user-avatars")
    {
    ...
    public async Task DeleteAsync(string blobUrl, string containerName = "user-avatars")
    {
